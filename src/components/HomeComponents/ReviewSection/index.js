...
export default function ReviewSection() {
    ...
    return (
        <>
            {addScript && (
                <Helmet>
                    <script async src="https://www.jscache.com/wejs?wtype=selfserveprop&amp;uniq=748&amp;locationId=19141578&amp;lang=en_UK&amp;rating=true&amp;nreviews=4&amp;writereviewlink=true&amp;popIdx=true&amp;iswide=true&amp;border=false&amp;display_version=2" data-loadtrk onload="this.loadtrk=true"></script>
                </Helmet>
            )}
                        ...
                        <div className="grid__12 grid__md-6">
                            <AnimateOnScroll from="bottom" rootMargin="100px 0px" animateOut={false}>
                                <div className={style.ReviewSection_box}>
                                    <Box>
                                        <div id="TA_selfserveprop748" className={`TA_selfserveprop ${style.ReviewSection_box_widget}`}><ul id="CEkFmKrMfu1" className="TA_links O3DeLF1BMrf1"><li id="VeTaib" className="8ASPMz2bzQ"><a target="_blank" rel="noreferrer" href="https://www.tripadvisor.co.uk/Restaurant_Review-g187047-d19141578-Reviews-Hooker_Eight-Gloucester_Cotswolds_England.html"><img src="https://www.tripadvisor.co.uk/img/cdsi/img2/branding/v2/Tripadvisor_lockup_horizontal_secondary_registered-11900-2.svg" alt="TripAdvisor"/></a></li></ul></div>
                                    </Box>
                                </div>
                            </AnimateOnScroll>
                        </div>
